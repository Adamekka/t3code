...
function Shell({
  ...
  return (
    <div
      ...
      className={cn(
        "group/composer-surface relative isolate w-full",
...
function ContextStrip({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/composer-context relative isolate mx-auto -mt-4 flex w-[calc(100%-2.75rem)] items-center gap-2 overflow-x-clip overflow-y-visible ps-1 pe-2 pt-5 pb-1",
