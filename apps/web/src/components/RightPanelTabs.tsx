...
const SURFACE_DISABLED_REASONS = {
  ...
  todos: "Todos are only available from a thread.",
} as const;
...
function RightPanelEmptyState(props: {
  ...
  const actions = [
    ...
    {
      label: "Todos",
      description: "Follow this thread's current checklist.",
      icon: ListTodo,
      shortcut: "L",
...
export function RightPanelTabs(props: RightPanelTabsProps) {
  ...
  const addSurfaceActions = [
    ...
    },
    {
      ...
      shortcut: "L",
      available: props.todosAvailable,
      disabledReason: SURFACE_DISABLED_REASONS.todos,
      onClick: props.onAddTodos,
    },
    {
      label: "Pull request",
